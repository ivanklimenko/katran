...
- **Открытые решения владельца** (спека 12): Pages на приватном репо (сделать публичным / ручной запуск / оставить красным); буква `StatusDot` на светлых тонах (контраст 3.0–3.2).
